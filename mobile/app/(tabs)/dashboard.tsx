...
//           "http://192.168.29.224:3000/api/getTransactions",
//           {
//             headers: {
...
//           transaction => transaction.status?.toLowerCase() === "alert"
//         ).length;

//         setTotalAlerts(alertCount);

//         console.info(`Transaction data processed successfully | Total: ${totalTransactions} | Alerts: ${alertCount}`);
//       } catch (error) {
//         console.error(
//           "TRANSACTION_FETCH_FAILED: Failed to retrieve transaction data",
//           {
//             timestamp: new Date().toISOString(),
//             endpoint: "http://192.168.29.224:3000/api/getTransactions",
//             error: error.message,
...
//           message: "Unable to load transaction data. Please try again later.",
//           timestamp: new Date().toISOString(),
//           severity: "high"
//         });
